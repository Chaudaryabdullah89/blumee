  ...
  return (
    <div className="flex-1 w-full bg-[#FCFCFD]">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-28 pb-20">
        {/* Background looking up at skyscraper */}
        <div
        ...
        <div className="relative max-w-5xl mx-auto px-6 md:px-8 w-full z-10 text-center flex flex-col gap-6 items-center">
          ...
          <h1 className="font-sans font-black text-4xl md:text-6xl lg:text-7xl leading-tight tracking-tighter text-white uppercase drop-shadow-lg max-w-4xl">
            We Shape <span className="text-brand-gold font-black">Skyline</span> & <br />
          ...
          <p className="font-sans font-medium text-sm md:text-base text-slate-300 max-w-2xl leading-relaxed tracking-wide">
            Blume Technical Services is Dubai's premier commercial fit-out, technical solutions, and building contractor.
            We blend creative design with technical excellence, precision masonry, and certified quality.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-sans font-black text-3xl md:text-5xl text-brand-navy leading-tight tracking-tight uppercase">
                  Founded on Trust, Driven by Innovation
                </h2>
              </div>

              <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                Established in 2017, Blume Technical Services began with a clear and singular objective: to elevate the standard of custom technical solutions and premium interior fit-outs across Dubai. We integrated meticulous craftsmanship, premium material selection, and rigorous quality control into a unified, high-performing service pipeline.
              </p>
              <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                Today, our operations deliver high-end commercial office renovations, premium retail spaces, bespoke residential villa updates, and precise structural shell works. We execute flawless tiling, robust block masonry, professional door system installations, and detailed plastering with a dedicated crew of in-house technical experts.
              </p>

              <div className="grid grid-cols-3 gap-6 mt-6 border-t border-slate-100 pt-8">
                <div>
                  <h4 className="font-sans font-black text-3xl md:text-4xl text-brand-navy">200+</h4>
                  <p className="text-[#64748b] text-xs font-bold uppercase tracking-wider mt-1">Projects Done</p>
                </div>
                <div>
                  <h4 className="font-sans font-black text-3xl md:text-4xl text-brand-navy">15+</h4>
                  <p className="text-[#64748b] text-xs font-bold uppercase tracking-wider mt-1">Years Experience</p>
                </div>
                <div>
                  <h4 className="font-sans font-black text-3xl md:text-4xl text-brand-navy">99%</h4>
                  <p className="text-[#64748b] text-xs font-bold uppercase tracking-wider mt-1">Client Trust</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-slate-100 shadow-xl border border-black/[0.04]">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-6 rounded-2xl bg-white/70 backdrop-blur-md border border-white/80 shadow-md">
                  ...
                  <p className="text-slate-700 text-[11px] md:text-xs leading-relaxed">
                    Every project is managed under ISO 9001 and ISO 45001 international building standards.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            {
              title: "Integrity",
              desc: "Unbreakable transparency. We operate with strict regulatory alignment and daily audits so you get absolute clarity on budget and materials.",
              icon: ShieldCheck
            },
            {
              title: "Precision",
              desc: "Micro-estimating down to single masonry blocks and concrete layers, preventing standard construction budget overrides completely.",
              icon: Ruler
            },
            {
              title: "Innovation",
              desc: "Deploying high-density concrete mixes, sustainable materials, and smart facility configurations to ensure your structures are future-proof.",
              icon: Cpu
            },
            {
              title: "Safety",
              desc: "Operating strict zero-accident sites. Our rigorous onsite training regimens and AI-driven monitoring prevent risks at all levels.",
              icon: HardHat
            }
          ].map((val, idx) => {
            const Icon = val.icon;
            ...
            {[
              {
                ...
                desc: "An industry veteran with 20+ years of technical services and premium commercial fit-out leadership across the UAE."
              },
              {
                name: "Sara Rahman",
                role: "Lead Project Manager",
                img: "photo-1573496359142-b8d87734a5a2",
                desc: "Specializes in premium tiling layout optimization, structural block work coordinates, and Dubai municipality quality codes."
              },
              {
                name: "Zain Malik",
                role: "Head of Carpentry & Fit-Out",
                img: "photo-1519085360753-af0119f7cbe7",
                desc: "Expert in custom fit-out finishes, high-end wooden door systems, internal partitions, and plaster craftsmanship."
              }
            ].map((member, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className="p-6 md:p-8 flex flex-col flex-1 gap-3">
                  ...
                  {/* LinkedIn link with Custom Inline SVG */}
          ...
          {[
            {
              ...
              desc: "Opened our head office in Dubai, UAE with a dedicated crew of 5 engineering professionals, prioritizing premium retail spaces and custom commercial fit-out."
            },
            {
              year: "2019",
              title: "Commercial Malls Expansion",
              desc: "Secured structural contracts for three major commercial plazas, scaling our field workforce and materials testing operations."
            },
            {
              year: "2021",
              title: "ISO Certification Achievements",
              desc: "Awarded ISO 9001:2015 and ISO 45001:2018 certifications, solidifying our zero-accident safety program and quality framework."
            },
            {
              year: "2024",
              title: "Reaching 200+ Projects Done",
              desc: "Successfully crossed the milestone of delivering 200 projects, recognized as one of the most reliable fit-out and technical solutions contractors in Dubai."
            }
          ].map((mil, idx) => (
        ...
        <div className="relative rounded-3xl bg-brand-navy p-8 md:p-16 text-center text-white overflow-hidden shadow-xl border border-white/[0.08] group">
          ...
          <div className="relative z-10 flex flex-col gap-6 items-center max-w-2xl mx-auto">
            ...
            <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
              Contact our engineering and design coordination team to review your development requirements, architectural blueprints, or materials planning.
            </p>
