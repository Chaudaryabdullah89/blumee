 ...
 *
 * WhatsApp is the primary inbound channel for trade contractors in the UAE, so
 * this sits on every page. Anchored bottom-left to stay clear of the
...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 left-6 z-50 flex items-center gap-0 overflow-hidden rounded-full bg-[#25D366] py-3 pl-3 pr-3 text-white shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:gap-2 hover:pr-5 hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
    >
      {/* WhatsApp glyph */}
      <svg
        viewBox="0 0 24 24"
      ...
      {/* Label reveals on hover / focus without shifting the icon */}
